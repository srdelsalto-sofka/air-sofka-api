package ec.com.airsofka.user.queries.responses;
...
public class UserResponse {
    ...
    public UserResponse(String id, LocalDateTime birthDate, String documentNumber, DocumentType documentType, String email, String firstLastName, Boolean frequent, String lastLastName, String name, Integer numberOfFlights, String password, String phone, String prefix, Role role, String title) {
        this.id = id;
