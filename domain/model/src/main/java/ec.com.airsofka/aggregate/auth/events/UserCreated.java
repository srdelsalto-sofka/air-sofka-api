...
public class UserCreated extends DomainEvent {
    ...
    public UserCreated(String userId, LocalDateTime birthDate, String documentNumber, DocumentType documentType, String email, String firstLastName, Boolean frequent, String lastLastName, String name, Integer numberOfFlights, String password, String phone, String prefix, Role role, String title) {
        super(EventsAuthEnum.USER_CREATED.name());
        this.userId = userId;
